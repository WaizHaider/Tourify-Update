...
class _FriendsNFamilyState extends State<FriendsNFamily> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Friends and Family", style: GoogleFonts.abel(fontWeight: FontWeight.bold),),
        elevation: 0,
        actions: [
          IconButton(
  ...
  void loadData(String filter) {
    tours.clear();
    final ref = FirebaseDatabase.instance.ref().child('Tours').child('FriendsNFamily');
