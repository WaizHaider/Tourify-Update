...
class AdminRegisteration extends StatefulWidget {
  const AdminRegisteration({super.key});

  @override
  State<AdminRegisteration> createState() => _SignUpScreenState();
}

class _SignUpScreenState extends State<AdminRegisteration> {
  void initState() {
    super.initState();
                      ...
                      onPressed: () async {
                        ...
                        try {
                          ...
                          await auth
                              ...
                              }).then((value) => Navigator.pushNamed(context, 'AdminSignIn'))
